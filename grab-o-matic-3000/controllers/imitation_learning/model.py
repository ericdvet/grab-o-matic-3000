...
class ImitationModelFiveLayers(nn.Module):
    def __init__(self, input_size, output_size):
        super(ImitationModelFiveLayers, self).__init__()
        self.fc1 = nn.Linear(input_size, 64)
...
class ImitationModelComplex(nn.Module):
    def __init__(self, input_size, output_size):
        super(ImitationModelComplex, self).__init__()
        self.fc1 = nn.Linear(input_size, 64)
...
if __name__ == '__main__':
    ...
    # model = ImitationModelComplex(input_size=observations_scaled.shape[1], output_size=actions.shape[1])
    ...
    # Save the model
    torch.save(model.state_dict(), 'imitation_model_complex.pth')
